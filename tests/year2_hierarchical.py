...
# test hierarchical algorithm on students of year 2 (test A: all features; test B: ETA, GENERE, CDL excluded; test C: ETA, GENERE, CDL, N_ESAMI excluded)

"""
files_to_execute = [
    (r"C:\GitLab\ai-project-template\src\scripts\3_hierarchical_analysis.py", r'C:\GitLab\ai-project-template\data\results\outputHIERARCHICAL\output_2A.xlsx'),
...
files_to_execute = [
    ('../src/scripts/3_hierarchical_analysis.py', '../data/results/outputHIERARCHICAL/output_2A.xlsx'),
