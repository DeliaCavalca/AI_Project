...
"""
files_to_execute = [
    (r"C:\GitLab\ai-project-template\src\scripts\4_umap_analysis.py", r'C:\GitLab\ai-project-template\data\results\outputUMAP\output_3A.xlsx'),
    ...
    (r"C:\GitLab\ai-project-template\src\scripts\4_umap_analysis.py", r'C:\GitLab\ai-project-template\data\results\outputUMAP\output_3C.xlsx'),
    
]"""
files_to_execute = [
    ('../src/scripts/4_umap_analysis.py', '../data/results/outputUMAP/output_3A.xlsx'),
    ('../src/scripts/4_umap_analysis.py', '../data/results/outputUMAP/output_3B.xlsx'),
    ('../src/scripts/4_umap_analysis.py', '../data/results/outputUMAP/output_3C.xlsx'),
]
